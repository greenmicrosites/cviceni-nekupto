...
const prod2btnEl = document.querySelector("#product2 button")
prod2btnEl.classList.remove("btn-primary")

const prod3titleEl = document.querySelector("#product3 .card-title")
prod3titleEl.classList.toggle("text-center")
